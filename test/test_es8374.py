...
class ES8374:
    ...
    def __init__(self, i2c_bus=None, i2c_addr=_ES8374_I2CADDR_DEFAULT):
        if i2c_bus == None:
            self.i2c_bus = I2C(I2C.I2C0, freq=100*1000, sda=31, scl=30)
        else:
        ...
        ##self._writeReg(0x72, 0x7F)# pll set:mode set
        ##self._writeReg(0x6E, 0x20)#  dac set
        ...
        (self._readReg(0x36))
        self._writeReg(0x36,20)
        (self._readReg(0x1A))
        self._writeReg(0x1A,0x18)
        self._writeReg(0x1A,0x18)
        self._writeReg(0x1D,0x12)
        self._writeReg(0x1E,0x20)
        (self._readReg(0x15))
        self._writeReg(0x15,0xBE)
        (self._readReg(0x10))
        self._writeReg(0x10,0xC0)
        (self._readReg(0x21))
        self._writeReg(0x21,0xD4)
        self._writeReg(0x00,0x3F)
        self._writeReg(0x00,0x3)
        self._writeReg(0x01,0x7F)
        (self._readReg(0xF))
        self._writeReg(0x0F,0x1)
        self._writeReg(0x6F,0xA0)
        self._writeReg(0x72,0x41)
        self._writeReg(0x09,0x1)
        self._writeReg(0x0C,0x8)
        self._writeReg(0x0D,0x13)
        self._writeReg(0x0E,0xE0)
        self._writeReg(0x0A,0x8A)
        self._writeReg(0x0B,0x8)
        self._writeReg(0x09,0x41)
        (self._readReg(0xF))
        self._writeReg(0x0F,0x4)
        self._writeReg(0x06,0x1)
        self._writeReg(0x07,0x0)
        self._writeReg(0x24,0x8)
        self._writeReg(0x36,0x0)
        self._writeReg(0x12,0x30)
        self._writeReg(0x13,0x20)
        (self._readReg(0x10))
        self._writeReg(0x10,0x0)
        (self._readReg(0x10))
        self._writeReg(0x10,0xC)
        (self._readReg(0x11))
        self._writeReg(0x11,0x0)
        (self._readReg(0x11))
        self._writeReg(0x11,0xC)
        self._writeReg(0x21,0x50)
        self._writeReg(0x22,0xFF)
        self._writeReg(0x21,0x14)
        self._writeReg(0x22,0x55)
        self._writeReg(0x08,0x21)
        self._writeReg(0x00,0x80)
        self._writeReg(0x25,0x0)
        self._writeReg(0x38,0x0)
        self._writeReg(0x14,0x8A)
        self._writeReg(0x15,0x40)
        self._writeReg(0x1A,0xA0)
        self._writeReg(0x1B,0x19)
        self._writeReg(0x1C,0x90)
        self._writeReg(0x1D,0x1)
        self._writeReg(0x1F,0x0)
        self._writeReg(0x1E,0x20)
        self._writeReg(0x28,0x70)
        self._writeReg(0x26,0x4E)
        self._writeReg(0x27,0x10)
        self._writeReg(0x29,0x0)
        self._writeReg(0x2B,0x0)
        self._writeReg(0x25,0x0)
        self._writeReg(0x38,0x0)
        self._writeReg(0x37,0x30)
        self._writeReg(0x6D,0x60)
        self._writeReg(0x71,0x5)
        self._writeReg(0x73,0x70)
        self._writeReg(0x1D,0x2)
        (self._readReg(0x1C))
        self._writeReg(0x1C,0x90)
        self._writeReg(0x1D,0x2)
        self._writeReg(0x1F,0x0)
        self._writeReg(0x1E,0xA0)
        (self._readReg(0x21))
        self._writeReg(0x21,0x14)
        self._writeReg(0x21,0x24)
        self._writeReg(0x38,0xC0)
        self._writeReg(0x37,0x0)
        self._writeReg(0x22,0x72)
        (self._readReg(0x21))
        self._writeReg(0x21,0x24)
        (self._readReg(0x10))
        self._writeReg(0x10,0xC)
        ...
        self._writeReg(0x10,0xC)
        (self._readReg(0x10))
        self._writeReg(0x1A,0xA8)
        (self._readReg(0x1A))
        self._writeReg(0x1A,0x88)
        self._writeReg(0x1D,0x12)
        self._writeReg(0x1E,0x20)
        (self._readReg(0x15))
        self._writeReg(0x15,0x40)
    ...
    def _readReg(self, regAddr):
        self.i2c_bus.writeto(int(self.i2c_addr & 0x7f), bytes([int(regAddr & 0x7f)]))
        tmp = (self.i2c_bus.readfrom(int(self.i2c_addr & 0x7f), 1))[0]
        #print('_readReg', hex(regAddr), hex(tmp))
        return tmp

    # write value to reg
    def _writeReg(self, regAddr, data):
        #print('_writeReg', hex(regAddr), hex(data))
        tmp = self.i2c_bus.writeto(self.i2c_addr, bytes([int(regAddr & 0x7f), int(data & 0xff)]))
        #tmp = self.i2c_bus.writeto_mem(self.i2c_addr, int(regAddr & 0x7f), int(data & 0x7f), mem_size=8)
        #time.sleep_ms(10)
        return tmp

    def logRegAll(self):
        regAll = self._readREGAll()
        print("\r\n#----------------")
        print("App |reg value:")
